...
presetup() {
    ...
    pushd ./artifacts/src/github.com/cura/go
...
VERSION="1"
CC_SRC_PATH="./artifacts/src/github.com/cura/"
CC_NAME="cura"
...
# --peerAddresses peer0.org1.cura.com:7051 --tlsRootCertFiles $PEER0_ORG1_CA --peerAddresses peer0.org2.cura.com:9051 --tlsRootCertFiles $PEER0_ORG2_CA
...
chaincodeInvoke() {
    ...
    ## Add private data
    export CAR=$(echo -n "{\"key\":\"1112\", \"make\":\"Tesla\",\"model\":\"Tesla A1\",\"color\":\"White\",\"owner\":\"pavan\",\"price\":\"10000\"}" | base64 | tr -d \\n)
    peer chaincode invoke -o localhost:7050 \
        --ordererTLSHostnameOverride orderer.cura.com \
        --tls $CORE_PEER_TLS_ENABLED \
        --cafile $ORDERER_CA \
